...
public class PatientServiceTests
{
    ...
    private readonly Mock<ILogger<PatientService>> loggerMock = new();

    private IPatientService Manager => new PatientService(patientAdapterMock.Object, doctorAdapterMock.Object, loggerMock.Object);
